...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        writer.println("creation#ca.uqam.registraire.uqac.Cours#inf3123");
        ...
        writer.println("creation#ca.uqam.registraire.uqac.Cours#inf3300");
        ...
        writer.println("creation#ca.uqam.registraire.uqac.Etudiant#mathilde");
        mathilde.setNom("Mathilde Boivin");
        writer.println("ecriture#mathilde#nom#Mathilde Boivin");
        Etudiant raymond = new Etudiant();
        writer.println("creation#ca.uqam.registraire.uqac.Etudiant#raymond");
        raymond.setNom("Raymond Sauve");
        writer.println("ecriture#raymond#nom#Raymond Sauve");
        // ne fonctionnera pas
        try {
            writer.println("fonction#inf3123#getNote#ca.uqam.registraire.uqac.Etudiant:mathilde");
            float note = inf3123.getNote(mathilde);
        } catch (Exception ex) {
            // writer.println("Fonction failed: " + ex);
        }
        mathilde.inscrisDansCours(inf3123);
        writer.println("fonction#mathilde#inscrisDansCours#ca.uqam.registraire.uqac.Cours:inf3123");
        inf3123.attributeNote(mathilde, 3.7f);
        writer.println("fonction#inf3123#attributeNote#ca.uqam.registraire.uqac.Etudiant:mathilde,float:3.7");
        float noteInf3123 = inf3123.getNote(mathilde);
        writer.println("fonction#inf3123#getNote#ca.uqam.registraire.uqac.Etudiant:mathilde");
        mathilde.inscrisDansCours(inf3300);
        writer.println("fonction#mathilde#inscrisDansCours#ca.uqam.registraire.uqac.Cours:inf3300");
        inf3300.attributeNote(mathilde, 4.0f);
        writer.println("fonction#inf3300#attributeNote#ca.uqam.registraire.uqac.Etudiant:mathilde,float:4.0");
        float moyenneMathilde = mathilde.getMoyenne();
        writer.println("fonction#mathilde#getMoyenne#");

        raymond.inscrisDansCours(inf3123);
        writer.println("fonction#raymond#inscrisDansCours#ca.uqam.registraire.uqac.Cours:inf3123");
        raymond.inscrisDansCours(inf3300);
        writer.println("fonction#raymond#inscrisDansCours#ca.uqam.registraire.uqac.Cours:inf3300");
        inf3123.attributeNote(raymond, 3.0f);
        writer.println("fonction#inf3123#attributeNote#ca.uqam.registraire.uqac.Etudiant:raymond,float:3.0");
        inf3300.attributeNote(raymond, 2.7f);
        writer.println("fonction#inf3300#attributeNote#ca.uqam.registraire.uqac.Etudiant:raymond,float:2.7");
